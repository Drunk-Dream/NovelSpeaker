# NovelSpeaker UI 统一与迁移 Backlog（已归档）

> 归档日期：2026-08-13。本文保留公共视觉资源体系重构、正式 UI 迁移、缓存管理导出和 Icon Foreground Contract 收口阶段的完整任务记录。所有任务均已完成；当前开发顺序以 `../TASK_BACKLOG.md` 为准。
