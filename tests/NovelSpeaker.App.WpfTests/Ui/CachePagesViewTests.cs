    ...
    private void CacheManagementPage_constrains_workspace_and_scrolls_both_columns_independently()
    {
        WpfTestHost.RunInSta(() =>
        {
            ...
            try
            {
                ...
                Assert.Same(page.FindResource("App.Button.InteractionHost"), firstBookButton.Style);
                ...
                Assert.Same(page.FindResource("App.Button.InteractionHost"), firstChapterButton.Style);
