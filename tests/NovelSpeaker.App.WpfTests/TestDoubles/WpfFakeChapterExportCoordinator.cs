...
internal sealed class WpfFakeChapterExportCoordinator : IChapterExportCoordinator
{
    public WpfFakeChapterExportCoordinator(ChapterExportSnapshot? snapshot = null)
    {
